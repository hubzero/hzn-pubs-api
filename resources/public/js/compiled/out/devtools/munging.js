...
var o30524 = temp__5718__auto__;
var temp__5718__auto____$1 = (o30524["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o30525 = temp__5718__auto____$1;
return (o30525["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29634__auto__ = f;
return (o__29634__auto__["toString"]).call(o__29634__auto__);
} else {
return "";
}
}catch (e30526){var _ = e30526;
return "";
}});
...
try{var o__29634__auto___30528 = t;
(o__29634__auto___30528["cljs$lang$ctorPrWriter"]).call(o__29634__auto___30528,t,writer);
}catch (e30527){var __30529 = e30527;
}
...
var char_code = (function (){var o__29634__auto__ = (new String(char$));
return (o__29634__auto__["charCodeAt"]).call(o__29634__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29634__auto__ = String;
return (o__29634__auto__["fromCharCode"]).call(o__29634__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30530 = num_code;
switch (G__30530) {
case (1):
return (185);
...
var o__29634__auto__ = String;
return (o__29634__auto__["fromCharCode"]).call(o__29634__auto__,superscript_code);
});
/**
...
}catch (e30532){var _e__29641__auto__ = e30532;
return false;
}})())){
...
var vec__30533 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30533,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o30536 = temp__5718__auto__;
var temp__5718__auto____$1 = (o30536["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o30537 = temp__5718__auto____$1;
return (o30537["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30540){
var vec__30541 = p__30540;
var ns_detector = cljs.core.nth.call(null,vec__30541,(0),null);
...
var G__30547 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30548 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30547;
remaining_tokens = G__30548;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30538){
...
var vec__30552 = cljs.core.split_with.call(null,(function (p1__30551_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30551_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30552,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30552,(1),null);
...
var vec__30558 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30558,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30558,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30561 = cljs.core.rest.call(null,remaining_tokens);
var G__30562 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30561;
name_tokens = G__30562;
continue;
} else {
...
var vec__30565 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30565,(0),null);
var arity = cljs.core.nth.call(null,vec__30565,(1),null);
var vec__30568 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30568,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30568,(1),null);
var vec__30571 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30571,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30571,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30571,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30571,(3),null);
...
var vec__30577 = result;
var munged_ns = cljs.core.nth.call(null,vec__30577,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30577,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30577,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30577,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30577,(4),null);
var arity = cljs.core.nth.call(null,vec__30577,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__30581 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__30581,(0),null);
var args = cljs.core.nth.call(null,vec__30581,(1),null);
var vec__30584 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30584,(0),null);
var name = cljs.core.nth.call(null,vec__30584,(1),null);
...
var G__30587 = (arity + (1));
var G__30588 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30589){
var vec__30590 = p__30589;
var arity = cljs.core.nth.call(null,vec__30590,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30590,(1),null);
...
return cljs.core.get.call(null,arities,p1__30593_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__30594_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30597){
var vec__30598 = p__30597;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30598,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30595){
var G__30596 = cljs.core.first.call(null,seq30595);
var seq30595__$1 = cljs.core.next.call(null,seq30595);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30596,seq30595__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__30606__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30606__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30606__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30606__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30607 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30607,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30607,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30607,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30607,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30607,(4),null);
var arity = cljs.core.nth.call(null,vec__30607,(5),null);
...
var o__29634__auto__ = f;
return (o__29634__auto__["getBasis"]).call(o__29634__auto__);
});
/**
...
}catch (e30611){var _e__29641__auto__ = e30611;
...
var G__30612 = (obj[cljs.core.first.call(null,path)]);
var G__30613 = cljs.core.rest.call(null,path);
obj = G__30612;
path = G__30613;
continue;
} else {
...
return (function (accum,p__30614){
var vec__30615 = p__30614;
var bit = cljs.core.nth.call(null,vec__30615,(0),null);
var protocol = cljs.core.nth.call(null,vec__30615,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30618){
var vec__30619 = p__30618;
var ns = cljs.core.nth.call(null,vec__30619,(0),null);
var name = cljs.core.nth.call(null,vec__30619,(1),null);
var selector = cljs.core.nth.call(null,vec__30619,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__30624,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30624,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__30624,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__30622_SHARP_){
return (obj[cljs.core.first.call(null,p1__30622_SHARP_)]);
});})(name,sorted_matches,vec__30624,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1570528834055
