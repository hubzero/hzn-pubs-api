...
}catch (e31382){var _e = e31382;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___31385 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___31385)){
var seen_errors_31386 = temp__5718__auto___31385;
if(cljs.core.truth_(seen_errors_31386.has(self))){
} else {
seen_errors_31386.add(self);

var temp__5720__auto___31387 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___31387)){
var sense_31388 = temp__5720__auto___31387;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_31388)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1570528834896
