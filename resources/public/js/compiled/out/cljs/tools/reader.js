...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__1980 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1980,ch);
...
if(("\\" === ch__$1)){
var ch_1981__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_1981__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_1981__$2);
} else {
}

var G__1982 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__1982;
continue;
}
}
...
var vec__1990 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1990,(0),null);
var start_column = cljs.core.nth.call(null,vec__1990,(1),null);
...
var G__1993 = cljs.core.conj_BANG_.call(null,a,form);
a = G__1993;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__1994 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__1995 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__1995;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__1994;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__1996 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1996,(0),null);
var start_column = cljs.core.nth.call(null,vec__1996,(1),null);
...
var vec__1999 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1999,(0),null);
var end_column = cljs.core.nth.call(null,vec__1999,(1),null);
...
var vec__2002 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2002,(0),null);
var start_column = cljs.core.nth.call(null,vec__2002,(1),null);
...
var vec__2005 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2005,(0),null);
var end_column = cljs.core.nth.call(null,vec__2005,(1),null);
...
var sb = (function (){var G__2014 = (new goog.string.StringBuffer());
G__2014.append(initch);
...
var G__2016 = (function (){var G__2015 = sb;
G__2015.append(ch);

return G__2015;
})();
var G__2017 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__2016;
ch = G__2017;
continue;
}
...
switch (G__2020) {
case "\\":
var G__2024 = (function (){var G__2021 = sb;
G__2021.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__2021;
})();
var G__2025 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__2024;
ch = G__2025;
continue;
...
break;
default:
var G__2026 = (function (){var G__2022 = sb;
G__2022.append(ch);

return G__2022;
})();
var G__2027 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__2026;
ch = G__2027;
continue;
...
var vec__2028 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2028,(0),null);
var end_column = cljs.core.nth.call(null,vec__2028,(1),null);
...
var vec__2031 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2031,(0),null);
var column = cljs.core.nth.call(null,vec__2031,(1),null);
...
var line = cljs.core.nth.call(null,vec__2036,(0),null);
var column = cljs.core.nth.call(null,vec__2036,(1),null);
...
var vec__2041 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2041,(0),null);
var column = cljs.core.nth.call(null,vec__2041,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__2046 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2046,(0),null);
var start_column = cljs.core.nth.call(null,vec__2046,(1),null);
...
var vec__2049 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2049,(0),null);
var end_column = cljs.core.nth.call(null,vec__2049,(1),null);
...
var G__2052 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__2052,true,null,opts,pending_forms);
...
var G__2053 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__2053)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__2053)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__2053)){
...
var _STAR_suppress_read_STAR__orig_val__2054 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__2055 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__2055;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__2054;
}});
...
var G__2056 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__2056,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__2056,rdr,first_line);
...
var G__2060 = matched;
var G__2061 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__2060;
finished = G__2061;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__2062 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__2063 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__2063;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__2062;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__2064 = cljs.tools.reader.arg_env;
var arg_env_temp_val__2065 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__2065;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__2066 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__2066,"(");
...
var G__2067 = (i + (1));
var G__2068 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__2064;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__2069 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__2069);
...
var G__2070 = cljs.core.next.call(null,s__$1);
var G__2071 = ret;
s__$1 = G__2070;
r = G__2071;
continue;
...
var G__2072 = cljs.core.next.call(null,s);
var G__2073 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__2072;
key_vals = G__2073;
continue;
} else {
...
var gensym_env_orig_val__2077 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__2078 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__2078;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__2077;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__2079 = token;
var G__2079__$1 = (((G__2079 == null))?null:cljs.core.subs.call(null,G__2079,(1)));
var G__2079__$2 = (((G__2079__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__2079__$1));
var G__2079__$3 = (((G__2079__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__2079__$2));
var G__2079__$4 = (((G__2079__$3 == null))?null:cljs.core.symbol.call(null,G__2079__$3));
if((G__2079__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__2079__$4);
}
})():(function (){var G__2080 = token;
var G__2080__$1 = (((G__2080 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__2080));
if((G__2080__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__2080__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e2087){if((e2087 instanceof Error)){
var e = e2087;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__2091,reader){
...
var opts = map__2092__$1;
var eof = cljs.core.get.call(null,map__2092__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___2100 = arguments.length;
var i__4731__auto___2101 = (0);
while(true){
if((i__4731__auto___2101 < len__4730__auto___2100)){
args__4736__auto__.push((arguments[i__4731__auto___2101]));

var G__2102 = (i__4731__auto___2101 + (1));
i__4731__auto___2101 = G__2102;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq2098){
var G__2099 = cljs.core.first.call(null,seq2098);
var seq2098__$1 = cljs.core.next.call(null,seq2098);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2099,seq2098__$1);
});


//# sourceMappingURL=reader.js.map?rel=1574244989733
