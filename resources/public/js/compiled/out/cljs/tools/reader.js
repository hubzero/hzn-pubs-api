...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__23199 = rdr;
...
if(("\\" === ch__$1)){
var ch_23200__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_23200__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_23200__$2);
} else {
}

var G__23201 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__23201;
continue;
}
}
...
var vec__23209 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23209,(0),null);
var start_column = cljs.core.nth.call(null,vec__23209,(1),null);
...
var G__23212 = cljs.core.conj_BANG_.call(null,a,form);
a = G__23212;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__23213 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__23214 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__23214;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__23213;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__23215 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23215,(0),null);
var start_column = cljs.core.nth.call(null,vec__23215,(1),null);
...
var vec__23218 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23218,(0),null);
var end_column = cljs.core.nth.call(null,vec__23218,(1),null);
...
var vec__23221 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23221,(0),null);
var start_column = cljs.core.nth.call(null,vec__23221,(1),null);
...
var vec__23224 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23224,(0),null);
var end_column = cljs.core.nth.call(null,vec__23224,(1),null);
...
var vec__23227 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23227,(0),null);
var start_column = cljs.core.nth.call(null,vec__23227,(1),null);
...
var vec__23230 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23230,(0),null);
var end_column = cljs.core.nth.call(null,vec__23230,(1),null);
...
var sb = (function (){var G__23233 = (new goog.string.StringBuffer());
G__23233.append(initch);
...
var G__23235 = (function (){var G__23234 = sb;
G__23234.append(ch);

return G__23234;
})();
var G__23236 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__23235;
ch = G__23236;
continue;
}
...
switch (G__23239) {
case "\\":
var G__23243 = (function (){var G__23240 = sb;
G__23240.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__23240;
})();
var G__23244 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23243;
ch = G__23244;
continue;
...
break;
default:
var G__23245 = (function (){var G__23241 = sb;
G__23241.append(ch);

return G__23241;
})();
var G__23246 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23245;
ch = G__23246;
continue;
...
var vec__23247 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23247,(0),null);
var end_column = cljs.core.nth.call(null,vec__23247,(1),null);
...
var line = cljs.core.nth.call(null,vec__23255,(0),null);
var column = cljs.core.nth.call(null,vec__23255,(1),null);
...
var vec__23260 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23260,(0),null);
var column = cljs.core.nth.call(null,vec__23260,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__23265 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23265,(0),null);
var start_column = cljs.core.nth.call(null,vec__23265,(1),null);
...
var vec__23268 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23268,(0),null);
var end_column = cljs.core.nth.call(null,vec__23268,(1),null);
...
var G__23271 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__23271,true,null,opts,pending_forms);
...
var G__23272 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__23272)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__23272)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__23272)){
...
var _STAR_suppress_read_STAR__orig_val__23273 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__23274 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__23274;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__23273;
}});
...
var G__23275 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__23275,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__23275,rdr,first_line);
...
var G__23279 = matched;
var G__23280 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__23279;
finished = G__23280;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__23281 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__23282 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__23282;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__23281;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__23283 = cljs.tools.reader.arg_env;
var arg_env_temp_val__23284 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__23284;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__23285 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23285,"(");
...
var G__23286 = (i + (1));
var G__23287 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__23283;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__23288 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__23288);
...
var G__23289 = cljs.core.next.call(null,s__$1);
var G__23290 = ret;
s__$1 = G__23289;
r = G__23290;
continue;
...
var G__23291 = cljs.core.next.call(null,s);
var G__23292 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__23291;
key_vals = G__23292;
continue;
} else {
...
var gensym_env_orig_val__23296 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__23297 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__23297;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__23296;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__23298 = token;
var G__23298__$1 = (((G__23298 == null))?null:cljs.core.subs.call(null,G__23298,(1)));
var G__23298__$2 = (((G__23298__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23298__$1));
var G__23298__$3 = (((G__23298__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23298__$2));
var G__23298__$4 = (((G__23298__$3 == null))?null:cljs.core.symbol.call(null,G__23298__$3));
if((G__23298__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__23298__$4);
}
})():(function (){var G__23299 = token;
var G__23299__$1 = (((G__23299 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23299));
if((G__23299__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23299__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e23306){if((e23306 instanceof Error)){
var e = e23306;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__23310,reader){
...
var eof = cljs.core.get.call(null,map__23311__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq23317){
var G__23318 = cljs.core.first.call(null,seq23317);
var seq23317__$1 = cljs.core.next.call(null,seq23317);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23318,seq23317__$1);
});


//# sourceMappingURL=reader.js.map?rel=1570528830066
