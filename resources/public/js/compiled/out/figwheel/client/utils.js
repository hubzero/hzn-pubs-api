...
return (new CustomEvent(event_name,(function (){var obj28040 = ({"detail":data});
return obj28040;
})()));
} else {
...
var f = (function (){var pred__28047 = cljs.core._EQ_;
var expr__28048 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28047.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28048))){
return ((function (pred__28047,expr__28048){
return (function (p1__28041_SHARP_){
return console.warn(p1__28041_SHARP_);
});
;})(pred__28047,expr__28048))
} else {
if(cljs.core.truth_(pred__28047.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28048))){
return ((function (pred__28047,expr__28048){
return (function (p1__28042_SHARP_){
return console.debug(p1__28042_SHARP_);
});
;})(pred__28047,expr__28048))
} else {
if(cljs.core.truth_(pred__28047.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28048))){
return ((function (pred__28047,expr__28048){
return (function (p1__28043_SHARP_){
return console.error(p1__28043_SHARP_);
});
;})(pred__28047,expr__28048))
} else {
return ((function (pred__28047,expr__28048){
return (function (p1__28044_SHARP_){
return console.log(p1__28044_SHARP_);
});
;})(pred__28047,expr__28048))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28051){
...
var eval_fn = cljs.core.get.call(null,map__28052__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28054_SHARP_);
});})(new_def))
);
...
return (function (p__28055){
var vec__28056 = p__28055;
var ky = cljs.core.nth.call(null,vec__28056,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1570528832654
