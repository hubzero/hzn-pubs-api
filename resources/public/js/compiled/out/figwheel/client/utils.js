...
return (new CustomEvent(event_name,(function (){var obj28248 = ({"detail":data});
return obj28248;
})()));
} else {
...
var f = (function (){var pred__28255 = cljs.core._EQ_;
var expr__28256 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28255.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28256))){
return ((function (pred__28255,expr__28256){
return (function (p1__28249_SHARP_){
return console.warn(p1__28249_SHARP_);
});
;})(pred__28255,expr__28256))
} else {
if(cljs.core.truth_(pred__28255.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28256))){
return ((function (pred__28255,expr__28256){
return (function (p1__28250_SHARP_){
return console.debug(p1__28250_SHARP_);
});
;})(pred__28255,expr__28256))
} else {
if(cljs.core.truth_(pred__28255.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28256))){
return ((function (pred__28255,expr__28256){
return (function (p1__28251_SHARP_){
return console.error(p1__28251_SHARP_);
});
;})(pred__28255,expr__28256))
} else {
return ((function (pred__28255,expr__28256){
return (function (p1__28252_SHARP_){
return console.log(p1__28252_SHARP_);
});
;})(pred__28255,expr__28256))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28259){
...
var eval_fn = cljs.core.get.call(null,map__28260__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28262_SHARP_);
});})(new_def))
);
...
return (function (p__28263){
var vec__28264 = p__28263;
var ky = cljs.core.nth.call(null,vec__28264,(0),null);
var v = cljs.core.nth.call(null,vec__28264,(1),null);
...
if(cljs.core.truth_((function (){var and__4120__auto__ = (typeof localStorage !== 'undefined');
if(and__4120__auto__){
...
//# sourceMappingURL=utils.js.map?rel=1574245580490
