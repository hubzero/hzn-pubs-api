...
if(cljs.spec.alpha.valid_QMARK_.call(null,spec,item)){
return true;
} else {
...
if((((typeof this$ !== 'undefined')) && ((!((this$._uid == null)))))){
var id = this$._uid;
...
return (function() { 
var G__23033__delegate = function (args){
var this$ = this;
...
while (G__23034__i < G__23034__a.length) {G__23034__a[G__23034__i] = arguments[G__23034__i + 0]; ++G__23034__i;}
  args = new cljs.core.IndexedSeq(G__23034__a,0,null);
} 
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__23036){
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__23040){
var vec__23041 = p__23040;
var k = cljs.core.nth.call(null,vec__23041,(0),null);
var v = cljs.core.nth.call(null,vec__23041,(1),null);
...
glue.core.convert_component_config = (function glue$core$convert_component_config(p__23044){
...
var config = map__23045__$1;
var state = cljs.core.get.call(null,map__23045__$1,new cljs.core.Keyword(null,"state","state",-1988618099),cljs.core.PersistentArrayMap.EMPTY);
var data = cljs.core.get.call(null,map__23045__$1,new cljs.core.Keyword(null,"data","data",-232669377),((function (map__23045,map__23045__$1,config,state){
return (function (){
return cljs.core.PersistentArrayMap.EMPTY;
});})(map__23045,map__23045__$1,config,state))
);
var methods$ = cljs.core.get.call(null,map__23045__$1,new cljs.core.Keyword(null,"methods","methods",453930866),cljs.core.PersistentArrayMap.EMPTY);
var computed = cljs.core.get.call(null,map__23045__$1,new cljs.core.Keyword(null,"computed","computed",-1482016762),cljs.core.PersistentArrayMap.EMPTY);
var props = cljs.core.get.call(null,map__23045__$1,new cljs.core.Keyword(null,"props","props",453281727),cljs.core.PersistentVector.EMPTY);
...
var len__4730__auto___23050 = arguments.length;
var i__4731__auto___23051 = (0);
while(true){
if((i__4731__auto___23051 < len__4730__auto___23050)){
args__4736__auto__.push((arguments[i__4731__auto___23051]));

var G__23052 = (i__4731__auto___23051 + (1));
i__4731__auto___23051 = G__23052;
continue;
} else {
}
break;
...
return glue.core.emit.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4737__auto__);
});

glue.core.emit.cljs$core$IFn$_invoke$arity$variadic = (function (this$,label,args){
if(glue.core.valid_or_explain.call(null,new cljs.core.Keyword("glue.core","keyword","glue.core/keyword",156090459),label)){
} else {
...
/** @this {Function} */
glue.core.emit.cljs$lang$applyTo = (function (seq23047){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23048,G__23049,seq23047__$2);
});
...
if(glue.core.valid_or_explain.call(null,new cljs.core.Keyword("glue.core","keyword","glue.core/keyword",156090459),n)){
} else {
throw (new Error("Assert failed: (valid-or-explain :glue.core/keyword n)"));
}

if(glue.core.valid_or_explain.call(null,new cljs.core.Keyword("glue.core","component-config","glue.core/component-config",749918154),config)){
} else {
...
if(glue.core.valid_or_explain.call(null,new cljs.core.Keyword("glue.core","vue-config","glue.core/vue-config",223323041),config)){
} else {
...
//# sourceMappingURL=core.js.map?rel=1570528829570
