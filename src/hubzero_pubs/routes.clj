(ns hubzero-pubs.routes
  (:require [compojure.core :refer [defroutes context GET POST DELETE PUT]]
            ...
            [hubzero-pubs.models.authors :as authors]
            [hubzero-pubs.models.citations :as citations]
            [hubzero-pubs.models.files :as files]
            [hubzero-pubs.models.licenses :as licenses]
            [hubzero-pubs.models.prjs :as prjs]
            [hubzero-pubs.models.pubs :as pubs]
